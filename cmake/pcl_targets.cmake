...
macro(PCL_SUBSYS_OPTION _var _name _desc _default)
    ...
    if(NOT ("${subsys_status}" STREQUAL "AUTO_OFF"))
      ...
      if((NOT ${_default} OR NOT ${_opt_name}) OR ("${_default}" STREQUAL "AUTO_OFF"))
        set(${_var} FALSE)
        if(${ARGC} GREATER 4)
          set(_reason ${ARGV4})
        else(${ARGC} GREATER 4)
      ...
      endif((NOT ${_default} OR NOT ${_opt_name}) OR ("${_default}" STREQUAL "AUTO_OFF"))
  ...
  if(NOT ("${parent_status}" STREQUAL "AUTO_OFF") AND NOT ("${parent_status}" STREQUAL "OFF"))
    ...
    if(NOT ("${subsys_status}" STREQUAL "AUTO_OFF"))
      ...
      elseif(NOT ${_opt_name})
        ...
        PCL_DISABLE_DEPENDIES(${_parent}_${_name})
      else(NOT ${_default} OR NOT ${_opt_name})
        set(${_var} TRUE)
